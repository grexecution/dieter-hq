...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      aria-label="Toggle theme"
      onClick={toggleTheme}
      className="relative rounded-md p-1.5 text-zinc-500 transition-colors hover:bg-zinc-100 hover:text-zinc-900 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-100"
    >
